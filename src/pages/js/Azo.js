    ...
    <div className="azo_bolgan_katta">
        <div className="azo_bolgan_katta_div">
            ...
            <div className="azo_bolgan_katta_div_text">
                ...
                <button  onClick={()=>obuna()} id='azo_bolgan_katta_div_text_block_button'><span className='obuna_olin'>Отмена членства</span><span className='obuna_text'>Быть членом</span></button>
            </div>
        </div>
    </div>
    </div>
